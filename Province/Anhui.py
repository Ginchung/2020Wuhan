...
## File: anhui.py
## Run with 'python anhui.py'

# object 'sdct'
# Function: stores the info from official message
# Key: YYYY-MM-DD-HH

# Web source: http://wjw.ah.gov.cn/news_list_477_1.html
...
sdct['2020-02-03-00']='合肥75例、淮北8例、亳州39例、宿州21例、蚌埠37例、阜阳65例、淮南7例、滁州8例、六安20例、马鞍山28例、芜湖16例、宣城4例、铜陵18例、池州6例、安庆47例、黄山9例'
sdct['2020-02-04-00']='合肥81例、淮北11例、亳州48例、宿州23例、蚌埠43例、阜阳79例、淮南8例、滁州11例、六安30例、马鞍山28例、芜湖21例、宣城4例、铜陵19例、池州10例、安庆55例、黄山9例'
sdct['2020-02-05-00']='合肥93例、淮北14例、亳州58例、宿州24例、蚌埠48例、阜阳84例、淮南12例、滁州11例、六安34例、马鞍山30例、芜湖23例、宣城4例、铜陵19例、池州11例、安庆56例、黄山9例'
sdct['2020-02-06-00']=''

city=[]
latest='2020-02-06-00'
